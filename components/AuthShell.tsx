  ...
  return (
    <main
      style={{
        ...
        padding: 24,
        background:
          "radial-gradient(120% 80% at 50% 0%, rgba(227,30,36,.08), transparent 60%), var(--bg)",
      }}
    >
      <Link href="/">
        <Logo size={56} />
  ...
  return (
    <div className="sca-card" style={{ padding: 28, maxWidth: 360, textAlign: "center" }}>
      ...
      <p style={{ color: "var(--text-muted)", fontSize: 14, lineHeight: 1.5 }}>
        ...
        <br />
        Configura las llaves <code style={{ color: "#E31E24" }}>CLERK</code> en Vercel para habilitar el acceso.
      </p>
    </div>
  );
}
